          ...
          <div className="flex items-center justify-between h-20">
            ...
            <NavLink href="/resume-analyser" active={pathname === "/resume-analyser"}>Analyze Resume</NavLink>
              ...
              <div className="ml-8 flex items-center space-x-4">
                ...
                <div className="flex items-center bg-gradient-to-r from-orange-500 to-red-500 text-white px-3 py-1 rounded-full text-sm">
                  <Flame className="h-4 w-4 mr-1" />
                  <span>{userProfile?.currentStreak || 0} day{userProfile?.currentStreak !== 1 ? 's' : ''}</span>
                </div>
